...
from environment_wrapper.CarRacingEnvRewardShaping import CarRacingEnvironment
import random
...
# Design a different reward function that works better than the original one,
...
class CarRacingTD3Agent(TD3BaseAgent):
    ...
    def update_behavior_network(self):
        ...
        with torch.no_grad():
            ...
            noise  = torch.normal(0, policy_noise, a_next.shape, device=self.device).clamp(-noise_clip, noise_clip)
...
if __name__ == '__main__':
	...
	config = {
		...
		"logdir": 'log/CarRacing/reward_test2_off_reward/',
		"update_freq": 2,
		"eval_interval": 5,
		"eval_episode": 1,
	}
	agent = CarRacingTD3Agent(config)
	# agent.load(load_path="./log/CarRacing/reward_function_design/model_214887_931.pth")
	agent.train()
