...
# Compare the effects of adding different levels of action noise (exploartion noise) in TD3.
# Try increasing or decreasing the magnitude of action noise in TD3 and observe how it affects algorithm convergence speed and stability
# and explain.
...
class CarRacingTD3Agent(TD3BaseAgent):
    ...
    def update_behavior_network(self):
        ...
        with torch.no_grad():
            ...
            policy_noise = 0.1  # 0.2 -> 0.1
            noise_clip = 0.25   # 0.5 -> 0.25
...
if __name__ == '__main__':
	...
	config = {
		...
		"logdir": 'log/CarRacing/action_noise_injection/',
		"update_freq": 2,
		"eval_interval": 10,
		"eval_episode": 1,
	}
