...
# Compare the impact of enabling and disabling target policy smoothing in TD3
# Attempt to disable the component of target policy smoothing in TD3 and observe
# whether performance decreases, and explain
...
if __name__ == '__main__':
	...
	config = {
		...
		"logdir": 'log/CarRacing/target_policy_smoothing/',
		"update_freq": 2,
		"eval_interval": 10,
		"eval_episode": 1,
	}
