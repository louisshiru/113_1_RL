...
# Impact of Twin Q-Networks:
# -
# Compare the performance of using twin Q-networks and 
# single Q-networks in TD3 and explain.
...
if __name__ == '__main__':
	...
	config = {
		...
		"logdir": 'log/CarRacing/impact_of_twin_qNet/',
		"update_freq": 2,
		"eval_interval": 10,
		"eval_episode": 1,
	}
