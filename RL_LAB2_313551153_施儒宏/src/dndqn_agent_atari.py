...
class AtariDualingNetworkDQNAgent(DQNBaseAgent):
    def __init__(self, config):
        super(AtariDualingNetworkDQNAgent, self).__init__(config)
        ### TODO ###
        # initialize env
        ...
        self.behavior_net = DualingNetworkDQN(self.env.action_space.n)
        self.behavior_net.to(self.device)
        self.target_net = DualingNetworkDQN(self.env.action_space.n)
    ...
    def update_behavior_network(self):
        ...
        self.writer.add_scalar('DnDQN/Loss', loss.item(), self.total_time_step)
...
if __name__ == '__main__':
    ...
    agent = AtariDualingNetworkDQNAgent(config)
